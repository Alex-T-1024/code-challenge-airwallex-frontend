      ...
      >
        <defs>
          ...
          >
            ...
            <stop stop-color="#D200A3" offset="20.5611151%" />
            <stop stop-color="#FF135F" offset="40.6791003%" />
            <stop stop-color="#FF4F42" offset="63.2305343%" />
            <stop stop-color="#FF8E3C" offset="81.777071%" />
            <stop stop-color="#FFC94C" offset="100%" />
          </linearGradient>
        </defs>
        <g
          id="Homepage"
